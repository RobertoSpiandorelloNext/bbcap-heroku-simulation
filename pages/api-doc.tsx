  ...
  const spec: Record<string, any> = createSwaggerSpec({
    definition: {
      ...
      servers: [
        ...
        {
          url: "https://json-server-bbcap.herokuapp.com/data/",
          description: "Servidor de Homologação - Retorno fixo dos dados",
        },
      ],
      tags: [
        {
          ...
          description:
            "Operações para consulta das informações de Titulos de Capitalização",
        },
      ],
      components: {
        schemas: {
          CapitalizationBondsProductIdentificationData: {
            ...
            properties: {
              ...
              additionalInfo: {
                ...
                maxLength: 1024,
                example:
                  "https://ACME.exemplo/capitalizacao/tradicional/pdf/condicoes_gerais",
              },
          ...
          Participant: {
            ...
            required: ["brand", "name", "cnpjNumber"],
            properties: {
              brand: {
                type: "string",
                description:
          ...
          TermsAndConditions: {
            type: "object",
            required: ["susepProcessNumber", "detail"],
            properties: {
              susepProcessNumber: {
                type: "string",
                description:
                  "Sequência numérica utilizada para consulta dos processos eletrônicos na SUSEP, com caracteres especiais, conforme campo de consulta no site da SUSEP (XXXXX.XXXXXX/XXXX-XX)<br>Observação&#58; Mascaras da SUSEP – Serão permitidos todas as máscaras de Produtos. Limitar pelos códigos das Máscaras.",
                maxLength: 20,
          ...
          CapitalizationPeriodContributionAmount: {
            ...
            required: ["periodicity", "minimum", "maximum", "allowedValue"],
            properties: {
              periodicity: {
                type: "string",
                description:
          ...
          LatePayment: {
            type: "object",
            required: ["suspensionMonths", "periodExtensionOption"],
            properties: {
              suspensionMonths: {
                type: "number",
                description:
          ...
          ContributionPayment: {
            type: "object",
            required: ["paymentMethod", "updateIndex"],
            properties: {
              paymentMethod: {
          ...
          CapitalizationBondsProductPrizeDraw: {
            ...
            properties: {
              ...
              ruleDescription: {
                ...
                maxLength: 200,
                example:
                  "Sorteios próprios às terças-feiras Toda quarta-feira sorteios através da loteria federal.",
              },
              minimumContemplationProbability: {
                type: "string",
                pattern: "^[0-1]\\.\\d{6}$",
          ...
          Meta: {
            ...
            required: ["totalRecords", "totalPages", "requestDateTime"],
            properties: {
              totalRecords: {
                type: "integer",
                format: "int32",
          ...
          Phase4Meta: {
            type: "object",
            description: "Meta informações referente à API requisitada.",
            required: ["totalRecords", "totalPages"],
            properties: {
              totalRecords: {
                type: "integer",
                format: "int32",
        ...
        responses: {
          OKResponseCapitalizationBondsProductsList: {
            description:
              "Dados de título(s) de capitalização obtidos com sucesso.",
            content: {
              "application/json": {
                schema: {
                  type: "object",
